...
*
* 1. Directional Light;
* 2. Point light with attenuation;
* 3. Spotlight.
*
* @ref:
...
int main()
{
	...
	while (!glfwWindowShouldClose(window_ptr))
	{
		...
		glUniform1f(glGetUniformLocation(obj_shader.get_id(), "light.constant"), 1.0f);
		glUniform1f(glGetUniformLocation(obj_shader.get_id(), "light.linear"), 0.09f);
		glUniform1f(glGetUniformLocation(obj_shader.get_id(), "light.quadratic"), 0.032f);
