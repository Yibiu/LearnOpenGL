...
* 
* Lights effects + Material effects.
*
* @ref:
...
int main()
{
	...
	while (!glfwWindowShouldClose(window_ptr))
	{
		...
		glUniform3fv(glGetUniformLocation(obj_shader.get_id(), "material.ambient"), 1, glm::value_ptr(object_color));
		glUniform3fv(glGetUniformLocation(obj_shader.get_id(), "material.diffuse"), 1, glm::value_ptr(object_color));
		glUniform3fv(glGetUniformLocation(obj_shader.get_id(), "material.specular"), 1, glm::value_ptr(glm::vec3(0.5f, 0.5f, 0.5f)));
		glUniform1f(glGetUniformLocation(obj_shader.get_id(), "material.shininess"), 32.0f);
		light_color.x = sin(glfwGetTime() * 2.0f);
		light_color.y = sin(glfwGetTime() * 0.7f);
		light_color.z = sin(glfwGetTime() * 1.3f);
		glm::vec3 light_diffuse = light_color * glm::vec3(0.5f);
		glm::vec3 light_ambient = light_diffuse * glm::vec3(0.2f);
		glUniform3fv(glGetUniformLocation(obj_shader.get_id(), "light.ambient"), 1, glm::value_ptr(light_ambient));
		glUniform3fv(glGetUniformLocation(obj_shader.get_id(), "light.diffuse"), 1, glm::value_ptr(light_diffuse));
