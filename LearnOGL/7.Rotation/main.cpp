...
int main()
{
	...
	while (!glfwWindowShouldClose(window_ptr))
	{
		...
		scale += 0.001f;
		float rotation[4][4];
		rotation[0][0] = cosf(scale); rotation[0][1] = -sinf(scale); rotation[0][2] = 0.0f; rotation[0][3] = 0.0f;
		rotation[1][0] = sinf(scale); rotation[1][1] = cosf(scale); rotation[1][2] = 0.0f; rotation[1][3] = 0.0f;
		...
		glUniformMatrix4fv(world_location, 1, GL_TRUE, &rotation[0][0]);
