...
int main()
{
	...
	while (!glfwWindowShouldClose(window_ptr))
	{
		...
		scale += 0.001f;
		float scaling[4][4];
		scaling[0][0] = sinf(scale); scaling[0][1] = 0.0f; scaling[0][2] = 0.0f; scaling[0][3] = 0.0f;
		scaling[1][0] = 0.0f; scaling[1][1] = sinf(scale); scaling[1][2] = 0.0f; scaling[1][3] = 0.0f;
		scaling[2][0] = 0.0f; scaling[2][1] = 0.0f; scaling[2][2] = sinf(scale); scaling[2][3] = 0.0f;
